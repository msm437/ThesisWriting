...
% **************************************************
\newcommand{\thesisTitle}{Personally Natural Perception and Interaction in Mixed Reality}
...
%\part{Review on Medical Visualization}
...
\part{Methodology}
%\input{content/cudacm}
\input{content/cmvis}
\input{content/uscompounding}t
\cleardoublepage
