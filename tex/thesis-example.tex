...
% **************************************************
\newcommand{\thesisTitle}{Personalized Perception and Interaction with Medical Information in Mixed Reality}
...
\newcommand{\thesisSecondReviewer}{\TODO{Prof. }}
...
\input{content/4-PAST}
\input{content/4-PointingOR}
%%\input{content/4-AccessRW}
%
\input{content/5-CMR}
\input{contect/6-conclusionDis}
