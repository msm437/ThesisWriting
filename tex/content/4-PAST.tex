...
\addd{(The PAST calibration procedure is similar to Single Point Active Alignment Method (SPAAM) \cite{Tuceryan2000b}, which was designed to calibrate optical see-through HMDs. Our method, however, does not require any display and our main objective is to estimate a virtual eye center for \textit{eye-rooted} pointing gesture.)}
...
\begin{figure}
	\centering
	\includegraphics[width = \linewidth]{figures/4-PAST/Figures/hardWare}
