...
\end{figure}
\paragraph{Pointing Gesture for interaction in an egocentric setting}
...
\paragraph{Pointing Gesture recovery}  
...
%	\item It enables direct pointing interaction with objects and medias in front of the user without any visual feedback.
%\end{description}
