...
\begin{figure} [htb]
	...
	\includegraphics[width=1.0\textwidth]{figures/3-PointingOR/ORScenario.png}
	...
	\label{fig:3-PointingOR:ORScenario}       % Give a unique label
\end{figure}
...
\subsection{Hardware Setup \& Calibration}
...
\begin{figure}[htb]
	...
	\label{fig:3-PointingOR:Hardware}       % Give a unique label
\end{figure}
...
\begin{figure} [htb]
	...
	\label{fig:3-PointingOR:Calibration}       % Give a unique label
\end{figure}
...
\begin{figure} [htb]
	...
	\label{fig:3-PointingOR:Workflow}       % Give a unique label
\end{figure}
...
\begin{figure} [htb]
	\includegraphics[width=1\textwidth]{figures/3-PointingOR/MultiUserMultiSystem.png}
	...
	\label{fig:3-PointingOR:multiUserMultiSystem}       % Give a unique label
\end{figure}
...
\begin{figure}
	...
	\label{fig:3-PointingOR:ORSEnvironment}       % Give a unique label
\end{figure}
...
\begin{figure}
	...
	\label{fig:3-PointingOR:NASATLX}       % Give a unique label
\end{figure}

\section{Discussion \& Conclusion}%Outlook}
